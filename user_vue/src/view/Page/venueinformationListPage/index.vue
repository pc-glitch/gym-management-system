                ...
                <div class="product-info">
                  ...
                  <div class="product-attributes">
                        ...
                        <div v-if="product.name" class="attribute-item">
                          <span class="attribute-label">场地名称:</span>
                          <span class="attribute-value">{{ product.name }}</span>
                        </div>
                      
                    
                      
                        <div v-if="product.clubname" class="attribute-item">
                          <span class="attribute-label">俱乐部名称:</span>
                          <span class="attribute-value">{{ product.clubname }}</span>
                        </div>
                      
                    
                      
                        <div v-if="product.classify" class="attribute-item">
                          <span class="attribute-label">用途类型:</span>
                          <span class="attribute-value">{{ product.classify }}</span>
                        </div>
                      
                    
                      
                        <div v-if="product.yardstate" class="attribute-item">
                          <span class="attribute-label">场地状态:</span>
                          <span class="attribute-value">{{ product.yardstate }}</span>
                        </div>
...
const fetchProducts = async () => {
  ...
  try {
    ...
    const response = await requestApi.post("/api/venueinformation/page", filteredParams);
    if (response.code == 0) {
