                ...
                <div class="product-info">
                  ...
                  <div class="product-attributes">
                        ...
                        <div v-if="product.name" class="attribute-item">
                          <span class="attribute-label">商品名称:</span>
                        ...
                        <div v-if="product.classify" class="attribute-item">
                          <span class="attribute-label">所属分类:</span>
                          <span class="attribute-value">{{ product.classify }}</span>
                        </div>
                      
                    
                      
                        <div v-if="product.brand" class="attribute-item">
                        ...
                        <div v-if="product.units" class="attribute-item">
                          <span class="attribute-label">单位:</span>
                          <span class="attribute-value">{{ product.units }}</span>
                        </div>
...
const fetchProducts = async () => {
  ...
  try {
    ...
    const response = await requestApi.post("/api/commodityinformation/page", filteredParams);
    if (response.code == 0) {
